...
namespace Trivia_App.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameDifficulty = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    GameScorePercentage = table.Column<double>(type: "float", nullable: false),
                    DatePlayed = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TimePlayed = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_gameSnapshots", x => x.GameID);
                });
